...
// A simple client-side hashing function to avoid storing plain-text passwords.
// NOTE: For a production application, a proper backend with salted hashing (e.g., bcrypt) is essential.
